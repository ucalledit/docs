...
<Steps>
  ...
  <Step title="On-Chain Escrow Execution">
    ...
    All three transaction signatures and the escrow account address are stored in the database and displayed in the UI with links to Solana Explorer (devnet).

    <Card title="Payment Architecture" icon="link" href="/guides/payment-architecture">
      Learn more about the Privy TEE wallet integration, oracle-sponsored gas, and the `signTransaction` pattern.
    </Card>
